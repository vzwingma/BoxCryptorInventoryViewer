 ...
 *
 */
public class InventoryCellRenderer implements ObservableValue<Node>  {
	 ...
	 * @param cell
	 */
	public InventoryCellRenderer(final TreeTableCell<AbstractBCInventaireStructure, InventoryFileStatutEnum> cell){
		this.cell = cell;
	}
